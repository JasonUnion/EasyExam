...
set APP_HOME=C:\Users\10429\Desktop\EasyExam\scoreMarker
...
set PR_CLASSPATH=%APP_HOME%\target\scoreMarker.jar
 
REM Startup configuration
set PR_STARTUP=auto
set PR_STARTMODE=jvm
set PR_STARTCLASS=cn.bestick.easyexam.scoremarker.ScoreMarkerWin
